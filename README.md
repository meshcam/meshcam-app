...
React. Run the whole backend yourself — the hosted cloud is a convenience,
never a lock-in.
...
`trailcam` — renames are churn, the API is the contract.)
...
AGPL-3.0 — see [LICENSE](LICENSE). Self-hosting is free forever, full stop.
