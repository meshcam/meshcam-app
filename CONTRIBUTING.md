...
- **CLA**: code contributions require signing a lightweight Contributor
  License Agreement (you keep your copyright; you grant us the right to
  relicense — this is what lets the project offer commercial licenses that
  fund development). The CLA bot will prompt on your first PR.

Dev setup is in the README. Run `pytest` before sending a PR.
